...
def create_ics_calendar(prompt: str, ics_file: str = "./calendars/my_calendar.ics") -> str:
    ...
    try:
        ...
        print("###Error Reason###")
        print(str(e))
        error = "\n\n Error: " + str(e) + "\n\n The full error can be found within the calendar server terminal output."
        print("###Full Error###")
        print(traceback.format_exc())
        LLM_result = "There has been an error within the create ics file function. This could be due to using the wrong format or some other issue found within the calender server/functions." + error
    return LLM_result
...
def read_calendar(file_name: str = "./calendars/my_calendar.ics") -> str:
    ...
    try:
        ...
        print("###Full Error###")
        print(traceback.format_exc())
        LLM_result = "There has been an issue with reading the calendar file. Common causes of this include a missing or corrupt calendar file which may be fixed by using the create calendar tool to generate a new file." + error
    return LLM_result
...
def create_ics_calendar_with_context(
    ...
    try:
        ...
        print("###Full Error###")
        print(traceback.format_exc())
        LLM_result = "There has been an issue with updating the calendar. Common issues can be either the calendar file does not exist or is corrupted and needs to be created first using the create calendar tool" + error
    return LLM_result
