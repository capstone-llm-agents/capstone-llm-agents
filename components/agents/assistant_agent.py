...
from llm_mas.model_providers.openai.call_llm import get_embedding, call_llm
...
ASSISTANT_AGENT.add_action(AskFriendForHelp(embedding_model=get_embedding))
...
narrower.add_action_edge(AskFriendForHelp(embedding_model=get_embedding), [AskFriendForHelp(embedding_model=get_embedding),AssessResponse()], )
